...
class ProductPage(BasePage):
    ...
    def added_selected_book(self):
        ...
        self.book_in_basket = self.browser.find_element(
            *PPL.MESSAGE_WITH_BOOK_TITLE).text
    ...
    def price_corresponds_to_the_book(self):
        ...
        self.сost_book_in_basket = self.browser.find_element(
            *PPL.MESSAGE_WITH_PRICE).text
    ...
    def should_not_be_success_message(self):
        assert self.is_not_element_present(
            *PPL.SUCCESS_MESSAGE), "Success message is presented, but should not be"

    def success_message_is_disappeared(self):
        assert self.is_disappeared(
            *PPL.SUCCESS_MESSAGE), "Success message is disappeared"
